...
from mcp_location_server.models import GeocodeRequest, GeocodeResult, GeocodeResponse
...
class TestNominatimGeocodingService:
    ...
    async def test_geocode_success(self):
        ...
        with patch.object(httpx.AsyncClient, 'get') as mock_get:
            ...
            assert location.latitude == 38.8976633
            assert location.longitude == -77.0365739
            assert location.importance == 0.9
    ...
    async def test_reverse_geocode_success(self):
        ...
        with patch.object(httpx.AsyncClient, 'get') as mock_get:
            ...
            assert result.latitude == 38.8976633
            assert result.longitude == -77.0365739
